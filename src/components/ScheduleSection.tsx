...
const ITEMS: ScheduleItem[] = [
  {
    ...
    arabicSubtitle: "وصول الضيوف",
    description: "Guests arrive at the venue, welcomed with warm greetings and blessings.",
  ...
  {
    time: "2:00 PM",
    title: "The Royal Lunch",
    arabicSubtitle: "غداء الزفاف",
