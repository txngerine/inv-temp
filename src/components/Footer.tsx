...
export default function Footer() {
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Nikah Invitation: Shasna & Shafeeq",
      text: "You are cordially invited to witness the sacred Nikah union of Shasna Navas and Muhammed Shafeeq on July 04, 2026.",
  ...
  return (
    <footer className="relative border-t border-gold-300/10 py-16 px-6 overflow-hidden flex flex-col items-center justify-center font-sans bg-emerald-deep/60">
      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-8 z-10">
        ...
        {/* Small Footer Notice */}
        <div className="flex flex-col items-center gap-2 mt-4 text-[10px] tracking-[0.15em] uppercase font-light text-gold-400/50">
          <div>&copy; 2026 Shasna & Shafeeq. All Rights Reserved.</div>
        </div>
      </div>
